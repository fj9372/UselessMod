package net.frankie.uselessmod.compat;
...
import net.frankie.uselessmod.recipe.GemPolishingRecipe;
...
public class GemPolishingCategory implements IRecipeCategory<GemPolishingRecipe> {
    ...
    public static final ResourceLocation UID = new ResourceLocation(UselessMod.MOD_ID, "gem_polishing");

    public static final ResourceLocation TEXTURE = new ResourceLocation(UselessMod.MOD_ID,
    ...
    public Component getTitle() {
        return Component.translatable("block.uselessmod.gem_polishing_station");
    }
