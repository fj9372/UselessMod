package net.frankie.uselessmod.screen;
...
public class GemPolishingStationScreen extends AbstractContainerScreen<GemPolishingStationMenu> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(UselessMod.MOD_ID, "textures/gui/gem_polishing_station_gui.png");
