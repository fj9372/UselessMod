...
import net.frankie.uselessmod.item.custom.*;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> WOULDNT_SWORD = ITEMS.register("wouldnt_sword",
            () -> new WouldntSwordItem(Tiers.WOOD, 3, -2.4F, new Item.Properties()));

    public static final RegistryObject<Item> STONED_SWORD = ITEMS.register("stoned_sword",
            () -> new StonedSwordItem(Tiers.STONE, 3, -2.4F, new Item.Properties()));
